...
class UserAccountServiceTest {
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("dpwns");
        UserAccount savedUserAccount = createSigningUpUserAccount("dpwns");
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("createdBy", userAccount.getUserId())      // createBy가 잘 들어갔는지 체크
