...
/*
    스프링부트Test로 띄우지 않아 ApplicationContext가 뜨지 않고
    필요한 의존성은 Mocking 하는 방식으로 빠르게 테스팅할 수 있다.
 */
 ...
 */
    ...
    @Test
    void givenNothing_whenCalling_thenReturnsAHashtags() {
        // Given
        ...
        // Then
        assertThat(expectedHashtags).isEqualTo(actualHashtags);
