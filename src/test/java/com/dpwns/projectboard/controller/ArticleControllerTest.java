...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 리스트 (게시판) 페이지 - 페이징, 정렬 기능능")
    @Test
    public void givenPagingAndSortingParams_whenSearchingArticlesPage_thenReturnArticlePages() throws Exception {
        // Given
